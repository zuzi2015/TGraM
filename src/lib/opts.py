...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--load_model', default='/workspace/fairmot/exp/mot/210619_airmot_fairmot/model_last.pth',
                                 help='/workspace/fairmot/exp/mot/210619_airmot_fairmot/model_last.pth')
        ...
        self.parser.add_argument('--trainval', action='store_true',
                                 help='include validation in training and '
                                      'test on test set')
        self.parser.add_argument('--num_frames', type=int, default=3,
                                 help='number of frames for inference.')
        self.parser.add_argument('--dataloader', type=str, default='jde',
                                 help='form of dataloader.')
        ...
        self.parser.add_argument('--val_airmat', default=True, help='val airmat')
        self.parser.add_argument('--val_airmst', default=False, help='val airmst')
        self.parser.add_argument('--val_airmot', default=False, help='val airmot')
        ...
        self.parser.add_argument('--save_images', action='store_true',
                                 help='save images when tracking.')
        self.parser.add_argument('--save_videos', action='store_true',
                                 help='save videos when tracking.')
        self.parser.add_argument('--output_dir', type=str, default='/output_path',
                                 help='path to the output result when tracking.')
        self.parser.add_argument('--exp_name', type=str, default='20210518_begin',
        ...
        self.parser.add_argument('--data_dir', type=str, default='/input_path')
