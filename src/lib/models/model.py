...
from .networks.tgram_dla import tgram_dlaseg
from .networks.tgram_mbv3 import tgram_mbv3
from .networks.tgram_mbseg import tgram_mbv3seg
...
_model_factory = {
  ...
  'tgramdla': tgram_dlaseg,
  'tgrammbv3': tgram_mbv3,
  'tgrammbseg': tgram_mbv3seg
}
